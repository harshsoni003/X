...
import { ShineButton } from './shine-button-css/shine'
import ShineButtonCode from './shine-button-code/page'
import { useState } from 'react'

export default function ShineButtonComponent() {
      ...
      <div className="space-y-8 px-4 sm:px-6 md:px-8">
        <div>
          ...
          <p className={`text-lg sm:text-xl mb-8 transition-colors
            ...
            Beautiful shimmering effect button
          </p>
