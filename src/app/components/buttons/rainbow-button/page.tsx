...
import { RainbowButton } from './rainbow-button-css/rainbow'
import RainbowButtonCode from './rainbow-button-code/page'
import { useState } from 'react'

export default function RainbowButtonComponent() {
      ...
      <div className="space-y-8 px-4 sm:px-6 md:px-8">
        <div>
          ...
          <p className={`text-lg sm:text-xl mb-8 transition-colors
            ...
            Beautiful rainbow animated button
          </p>
