...
import { StarBorderDemo } from './star-border-css/star'
import StarBorderCode from './star-border-code/page'
import { useState } from 'react'

export default function StarBorderComponent() {
      ...
      <div className="space-y-8 px-4 sm:px-6 md:px-8">
        <div>
          ...
          <p className={`text-lg sm:text-xl mb-8 transition-colors
            ...
            Beautiful animated star border button
          </p>
