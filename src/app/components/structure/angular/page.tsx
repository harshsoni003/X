...
export default function AngularSetup(): JSX.Element {
      ...
      <div className="space-y-6 sm:space-y-8 px-3 sm:px-6 md:px-8 max-w-full">
        <div>
          ...
          <p className={`text-base sm:text-lg mb-4 sm:mb-6
            ...
            Follow these steps to set up a new Angular project with InfinityUI
          </p>
        </div>
        ...
        <div className={`p-4 sm:p-6 rounded-xl border
          ...
          <p className={theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}>
            Get started quickly with our pre-configured Angular template
          </p>
        </div>
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className={`p-4 sm:p-6 rounded-xl border
            ...
            <div className={`p-3 sm:p-4 rounded-lg overflow-x-auto text-sm
              ...
              <code className="whitespace-pre-wrap break-words">ng new my-app --style=scss --routing=true</code>
            </div>
          </div>
          ...
          <div className={`p-4 sm:p-6 rounded-xl border
            ...
            <div className={`p-3 sm:p-4 rounded-lg overflow-x-auto text-sm
              ${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-100'}`}>
              <code className="whitespace-pre-wrap break-words">npm install @infinityui/angular tailwindcss @angular/animations</code>
            </div>
          </div>
          ...
          <div className={`p-4 sm:p-6 rounded-xl border
            ...
            <div className={`p-3 sm:p-4 rounded-lg overflow-x-auto text-sm
              ${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-100'}`}>
              <code className="whitespace-pre-wrap break-words">ng add @angular/material && ng add @ngrx/store</code>
            </div>
          </div>
        </div>
      </div>
