        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className={`p-4 sm:p-6 rounded-xl border
            ...
            <div className={`p-3 sm:p-4 rounded-lg overflow-x-auto text-sm
              ...
              <code className="whitespace-pre-wrap break-words">npx create-react-app my-app --template typescript</code>
            </div>
          </div>
          ...
          <div className={`p-4 sm:p-6 rounded-xl border
            ...
            <div className={`p-3 sm:p-4 rounded-lg overflow-x-auto text-sm
              ${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-100'}`}>
              <code className="whitespace-pre-wrap break-words">npm install @infinityui/react tailwindcss framer-motion</code>
            </div>
          </div>
          ...
          <div className={`p-4 sm:p-6 rounded-xl border
            ...
            <div className={`p-3 sm:p-4 rounded-lg overflow-x-auto text-sm
              ${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-100'}`}>
              <code className="whitespace-pre-wrap break-words">npx tailwindcss init -p</code>
            </div>
          </div>
        </div>
      </div>
