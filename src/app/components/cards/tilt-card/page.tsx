...
import { TiltSpotlight } from './tilt-card-css/tilt-spotlight'
import { Button } from '@/components/ui/button'
import TiltCardCode from './tilt-card-code/page'
import { useState } from 'react'

export default function TiltCardComponent() {
      ...
      <div className="space-y-8 px-4 sm:px-6 md:px-8">
        <div>
          ...
          <p className={`text-lg sm:text-xl mb-8 transition-colors
            ...
            A card component with tilt and spotlight effects.
          </p>
